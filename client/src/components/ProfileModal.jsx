            ...
            <div className='bg-white rounded-lg shadow p-6'>
                ...
                <form className="space-y-4" onSubmit={handleSaveProfile}>
                    ...
                    <div>
                        ...
                        <textarea className='w-full p-3 border border-gray-200 rounded-lg' 
                         placeholder='Enter a short bio '  rows={3}
                    ...
                    <div className='flex justify-end space-x-3 pt-3'>
                        ...
                        <button  type='submit' className='px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:from-indigo-600 hover:to-purple-700 transition-colors cursor-pointer'>Save Changes</button>
