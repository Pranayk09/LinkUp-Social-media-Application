...
const ReecentMessages = () => {
    ...
    const fetchReecentMessages = async()=>{
      try {
    ...
    useEffect(()=>{
      if(user){
       fetchReecentMessages();
      const interval =  setInterval(fetchReecentMessages, 30000);
...
export default ReecentMessages
