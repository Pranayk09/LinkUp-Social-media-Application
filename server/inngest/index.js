...
// function to  send reminder when new connection request  is added
...
// to delete story after 24 hours
...
const sendNotificationOfUnseenMessages = inngest.createFunction(
    ...
    {cron: "TZ=America/New_York 0 9 * * *"},  // function executed evryday at 9 AM 
    async({step})=>{
